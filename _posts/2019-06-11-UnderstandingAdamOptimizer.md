...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;Gradient=\frac{d}{dw}\min\sum_{i}^{n}{(y_i-wx_i)}^2" title="Differentiate Objective Function 1"/><br/>
 ...
 * **Analysis**
We will now analyse the changes in the moments with each iteration to understand the progress of the algorithm
